...
subroutine is_finite_test(x, y)
  ...
  ! CHECK:   %[[V_10:[0-9]+]] = select %[[V_9]], %c0{{.*}}, %[[V_8]] : i32
  ...
  ! CHECK:   %[[V_28:[0-9]+]] = select %[[V_27]], %c0{{.*}}, %[[V_26]] : i32
  ...
  ! CHECK:   %[[V_44:[0-9]+]] = select %[[V_43]], %c0{{.*}}, %[[V_42]] : i64
  ...
  ! CHECK:   %[[V_62:[0-9]+]] = select %[[V_61]], %c0{{.*}}, %[[V_60]] : i64
