...
void genInlinedAllocation(Fortran::lower::FirOpBuilder &builder, mlir::Location loc,
                     const fir::MutableBoxValue &box, mlir::ValueRange lbounds,
                     mlir::ValueRange extents, mlir::ValueRange lenParams,
                     llvm::StringRef allocName);

void genInlinedDeallocate(Fortran::lower::FirOpBuilder &builder, mlir::Location loc,
...
/// to be null).
fir::ExtendedValue genMutableBoxRead(Fortran::lower::FirOpBuilder &,
                                            mlir::Location,
                                            const fir::MutableBoxValue &,
