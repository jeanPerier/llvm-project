//===-------------- MutabelBox.cpp -- MutableBox utilities ----------------===//
//
...
#include "flang/Lower/MutableBox.h"
...
public:
  ...
  void setUnallocatedStatus() {
    if (box.isDescribedByVariables()) {
      ...
      auto deallocatedBox = fir::factory::createUnallocatedBox(builder, loc, box.getBoxTy(),
...
mlir::Value
fir::factory::createUnallocatedBox(Fortran::lower::FirOpBuilder &builder,
...
fir::MutableBoxValue
fir::factory::createTempMutableBox(Fortran::lower::FirOpBuilder &builder,
...
fir::ExtendedValue fir::factory::genMutableBoxRead(
...
mlir::Value fir::factory::genIsAllocatedOrAssociatedTest(
    Fortran::lower::FirOpBuilder &builder, mlir::Location loc,
...
void fir::factory::genFinalization(Fortran::lower::FirOpBuilder &builder,
                                     mlir::Location loc,
                                     const fir::MutableBoxValue &box) {
  auto addr = MutablePropertyReader(builder, loc, box).readBaseAddress();
...
void fir::factory::associateMutableBox(Fortran::lower::FirOpBuilder &builder,
                                         mlir::Location loc,
                                         const fir::MutableBoxValue &box,
...
void
fir::factory::genInlinedAllocation(Fortran::lower::FirOpBuilder &builder, mlir::Location loc,
...
void
fir::factory::genInlinedDeallocate(Fortran::lower::FirOpBuilder &builder, mlir::Location loc,
                     const fir::MutableBoxValue &box) {
  auto addr = MutablePropertyReader(builder, loc, box).readBaseAddress();
  genFinalizeAndFree(builder, loc, addr);
  MutablePropertyWriter{builder, loc, box}.setUnallocatedStatus();
...
void fir::factory::genReallocIfNeeded(Fortran::lower::FirOpBuilder &builder,
                                        mlir::Location loc,
                                        const fir::MutableBoxValue &box,
                                        mlir::ValueRange lbounds,
...
mlir::Value
fir::factory::getMutableIRBox(Fortran::lower::FirOpBuilder &builder,
                                mlir::Location loc,
                                const fir::MutableBoxValue &box) {
  MutablePropertyWriter{builder, loc, box}.syncIRBoxFromMutableProperties();
  return box.getAddr();
}
void fir::factory::syncMutableBoxFromIRBox(
    Fortran::lower::FirOpBuilder &builder, mlir::Location loc,
    const fir::MutableBoxValue &box) {
