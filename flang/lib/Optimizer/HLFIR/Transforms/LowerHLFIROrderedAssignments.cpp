...
private:
  ...
  bool isRequiredInCurrentRun(hlfir::OrderedAssignmentTreeOpInterface &node);
...
OrderedAssignmentRewriter::generateYieldedEntity(mlir::Region &region) {
  ...
  // Clone all operation except the final hlfir.yield.
...
/// Lower an order assignment tree to fir.do_loop and hlfir.assign given
/// a schedule.
